...
const baseNavItems = [
  ...
  { href: "/gym-portal/manage/gallery", label: "Galerija", icon: "gallery" },
  { href: "/gym-portal/manage/settings", label: "Podešavanja", icon: "settings" },
];

// Owner-only nav items
const ownerNavItems = [
  { href: "/gym-portal/manage/locations", label: "Lokacije", icon: "locations" },
];
...
export default function ManageLayout({
  ...
  // Owners only see locations, admins see all base items
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <Link href={isOwner ? "/gym-portal/manage/locations" : "/gym-portal/manage"} className="flex items-center gap-3">
                {gym?.logo ? (
                  <img
                    src={gym.logo}
                    alt={gym.name}
                ...
                <div className="hidden sm:block">
                  ...
                  <span className="text-sm text-foreground-muted ml-2">{isOwner ? "Owner" : "Admin"}</span>
                </div>
              </Link>
            </div>
