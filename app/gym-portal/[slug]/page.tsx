      ...
      <section id="features" className="py-24 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            {/* Supplement Shop (hidden until the storefront is enabled) */}
            {hasStore ? (
            ...
            <div className="group relative">
              ...
              <div className="relative h-full bg-gradient-to-br from-background-secondary/90 to-background-secondary/50 border border-white/10 group-hover:border-violet-500/30 rounded-3xl p-8 transition-all duration-300 overflow-hidden group-hover:translate-y-[-4px]">
                ...
                <h3 className="text-xl font-bold text-foreground mb-2 transition-colors duration-300 group-hover:text-white">Zajednica</h3>
                <p className="text-foreground-muted text-sm leading-relaxed">
                  Trenirajte uz motivišuću zajednicu ljudi sa istim ciljem — zajedno je lakše i zabavnije.
                </p>
              </div>
            </div>
            )}
